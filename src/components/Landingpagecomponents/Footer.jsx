import logo from '../../Images/logotys.png'
...
const Footer = () => {
    return (
        ...
        <footer className="footer mt-5 ">
          ...
          <section className=" py-4 py-md-5 py-xl-8 border-top border-light "  style={{ backgroundColor: '#1658AC' }}>
            <div className="container overflow-hidden">
              <div className="row gy-4 gy-lg-0 justify-content-xl-between">
                ...
                <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                  <div className="widget">
                    <h4 className="widget-title mb-4 text-white">Get in Touch</h4>
                    <address className="mb-4 text-white">
                      8014 Edith Blvd NE, Albuquerque, New York, United States
                    </address>
                    <p className="mb-1">
                      <a
                        className="link-secondary text-decoration-none text-white"
                ...
                <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                  <div className="widget">
                    <h4 className="widget-title mb-4 text-white">Learn More</h4>
                    <ul className="list-unstyled">
                      <li className="mb-2">
                        <a href="#!" className="link-secondary text-decoration-none text-white">
                          About
                        </a>
                      </li>
                      <li className="mb-2">
          ...
          <div className=" py-4 py-md-5 py-xl-8 border-top border-light-subtle "  style={{ backgroundColor: '#1658AC' }}>
            <div className="container overflow-hidden">
              <div className="row gy-4 gy-md-0">
                <div className="col-xs-12 col-md-7 order-1 order-md-0">
                  ...
                  <div className="credits text-secondary text-center text-md-start mt-2 fs-7 text-white">
                    Built by{" "}
                    <a
