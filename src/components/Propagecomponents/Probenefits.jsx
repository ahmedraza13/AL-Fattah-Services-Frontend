      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-md-6 col-12  pro-benefits-text">
          ...
          <p>
            ...
            your company from facing heavy fines or penalties for failure to
            meet all government requirements.
          </p>
          <h3>Time Saving</h3>
          <p>
            Our corporate PRO services save you tons of time and stress from
            completing paperwork, typing and translating letters, and submitting
        ...
        <div className="col-lg-6 col-md-6 col-12  pro-benefits-text">
          ...
          <p>
            ...
            never have to stress about filling out paperwork or meeting
            submission deadlines!
          </p>
          <h3>100% Transparency</h3>
          <p>
            We believe in complete trust and transparency, which is why our
            expert PRO officers keep you updated with every step.
          </p>
        </div>
      </div>
    </div>
